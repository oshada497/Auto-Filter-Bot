...
from utils import get_size, temp, get_verify_status, is_subscribed, is_premium, clean_ascii, remove_urls
...
def get_reply_markup(s):
    buttons = [[
        InlineKeyboardButton('\U0001F50E Search Again', switch_inline_query_current_chat=s or '')
    ],[
